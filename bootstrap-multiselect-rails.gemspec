...
Gem::Specification.new do |spec|
  ...
  spec.description   = %q{Add Bootstrap Multiselect v0.9.8 to your rails app. See https://github.com/davidstutz/bootstrap-multiselect for more information about bootstrap-multiselect.}
  spec.summary       = %q{Add Bootstrap Multiselect v0.9.8 to your rails app.}
